...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full translate-x-1/2 flex-col-reverse p-4 sm:bottom-auto sm:right-[50%] sm:top-0 sm:flex-col md:max-w-[360px]",
      className
    )}
    {...props}
  />
